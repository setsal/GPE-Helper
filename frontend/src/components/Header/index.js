      ...
      fetch(`https://api.github.com/users/setsal/repos?per_page=100&sort=updated&page=0`)
        ...
        .then(data => {
          ...
          if (repo) {
            ...
            setGithubData({ ...githubData, stargazers_count: repo.stargazers_count, forks_count: repo.forks_count })
          }
        })
    }
    fetchData();
      ...
      <Menu fixed='top' inverted size='large'>
        <Container>
          ...
          <Menu.Item as='a' href='https://github.com/setsal/GPE-Helper' className="navbar-item github-source" style={{ lineHeight: '1.5' }} target="_blank">
            ...
            <div className="github-source-repository">setsal/GPE-Helper
                <ul className="github-facts">
                <li className="github-stars">{githubData.stargazers_count} Stars</li>
                <li className="github-forks" style={{ marginLeft: '3px' }}>• {githubData.forks_count} Fork</li>
              </ul>
            </div>
          </Menu.Item>
        </Container>
